...
import com.dressca.web.controller.dto.auth.GetUserResponse;
...
public class UserController {
  ...
  public ResponseEntity<GetUserResponse> getUser() throws Exception {

    String userId = UserIdThreadContextFilter.threadLocalUserId.get();
    GetUserResponse response = new GetUserResponse(userId);
