...
import { fetchCategoriesAndBrands, fetchItems } from '@/catalog/services/catalog-service'
import { addItemToBasket } from '@/basket/services/basket-service'
import { showToast } from '@/notification/services/notificationService'
import { storeToRefs } from 'pinia'
import { useSpecialContentStore } from '@/common/stores/special-content'
import { useCatalogStore } from '@/catalog/stores/catalog'
import CarouselSlider from '@/catalog/components/CarouselSlider.vue'
import { LoadingSpinnerOverlay } from '@/components/common/LoadingSpinnerOverlay'
import { useRouter } from 'vue-router'
import { currencyHelper } from '@/common/helpers/currencyHelper'
import { assetHelper } from '@/common/helpers/assetHelper'
import { i18n } from '@/common/locales/i18n'
import { errorMessageFormat } from '@/common/error/error-message-format'
import { HttpError } from '@/common/error/custom-error'
import { useCustomErrorHandler } from '@/common/error/custom-error-handler'
