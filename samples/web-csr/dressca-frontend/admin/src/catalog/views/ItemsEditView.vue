...
import ConfirmationModal from '@/catalog/components/ConfirmationModal.vue'
import NotificationModal from '@/catalog/components/NotificationModal.vue'
import { useRoute, useRouter } from 'vue-router'
import { useForm } from 'vee-validate'
import { catalogItemSchema } from '@/common/validation/validation-items'
import { ConflictError, NotFoundError } from '@/common/error/custom-error'
import type {
  GetCatalogBrandsResponse,
  GetCatalogCategoriesResponse,
  GetCatalogItemResponse,
} from '@/common/generated/api-client'
