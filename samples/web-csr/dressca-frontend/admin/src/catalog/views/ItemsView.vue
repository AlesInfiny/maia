...
import { assetHelper } from '@/catalog/helpers/assetHelper'
 ...
 */
const goToAddItem = () => {
  router.push({ name: catalogRouteNames.itemsAdd })
}
...
const goToEditItem = (id: string) => {
  router.push({ name: catalogRouteNames.itemsEdit, params: { itemId: id } })
}
</script>
