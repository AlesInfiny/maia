  ...
  <div class="container mx-auto gap-6">
    ...
    <div v-if="!showLoading">
      ...
      <div class="mx-2 my-8 flex justify-end">
        <button
          type="button"
          class="rounded-xs bg-green-600 px-4 py-2 text-xl font-bold text-white hover:bg-green-800"
          @click="goToAddItem"
        >
          アイテム追加
        </button>
        ...
        <tbody>
          ...
          >
            ...
            <td class="border text-center">
              <button
                type="button"
                class="rounded-xs bg-blue-600 px-4 py-2 font-bold text-white hover:bg-blue-800"
