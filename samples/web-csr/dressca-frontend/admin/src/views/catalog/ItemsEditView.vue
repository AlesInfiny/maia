      ...
      <div>
        ...
        <form class="text-xl">
          ...
          <div class="flex justify-end">
            ...
            <button
              type="button"
              class="rounded-sm bg-red-800 px-4 py-2 font-bold text-white hover:bg-red-900 disabled:bg-red-500 disabled:opacity-50"
            ...
            <button
              type="button"
              class="rounded-sm bg-blue-600 px-4 py-2 font-bold text-white hover:bg-blue-800 disabled:bg-blue-500 disabled:opacity-50"
