...
public class CatalogApplicationService {
  ...
  public List<CatalogItem> getCatalogItems(long brandId, long categoryId, int page, int pageSize) {
    ...
    apLog.debug(messages.getMessage(MessageIdConstant.D_CATALOG_GET_CATALOG_ITEMS,
  ...
  public int countCatalogItems(long brandId, long categoryId) {
    ...
    apLog.debug(messages.getMessage(MessageIdConstant.D_CATALOG_COUNT_CATALOG_ITEMS,
  ...
  public List<CatalogBrand> getBrands() {
    ...
    apLog.debug(messages.getMessage(MessageIdConstant.D_CATALOG_GET_BRANDS,
        new Object[] {},
        Locale.getDefault()));
  ...
  public List<CatalogCategory> getCategories() {
    ...
    apLog.debug(messages.getMessage(MessageIdConstant.D_CATALOG_GET_CATEGORIES,
        new Object[] {},
        Locale.getDefault()));
