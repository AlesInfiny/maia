package com.dressca.modules.orchestrator;
...
import com.dressca.modules.baskets.BasketNotFoundException;
import com.dressca.modules.baskets.BasketRepository;
import com.dressca.modules.baskets.CatalogItemInBasketNotFoundException;
import com.dressca.modules.catalog.CatalogDomainService;
import com.dressca.modules.catalog.CatalogItem;
import com.dressca.modules.catalog.CatalogNotFoundException;
import com.dressca.modules.catalog.CatalogRepository;
import com.dressca.modules.common.log.AbstractStructuredLogger;
import com.dressca.modules.config.ApplicationCoreTestConfig;
import com.dressca.modules.orchestrator.dto.BasketDetail;
import com.dressca.modules.order.Address;
import com.dressca.modules.order.CatalogItemOrdered;
import com.dressca.modules.order.EmptyBasketOnCheckoutException;
...
import com.dressca.modules.order.ShipTo;
...
public class ShoppingApplicationServiceTest {
  ...
  void testGetBasketDetail_正常系_カタログIDに対応するカタログ情報が取得されること() throws BasketNotFoundException {
    ...
    assertThat(actual.getCatalogItems().size()).isEqualTo(2);
    assertThat(actual.getCatalogItems().get(0).getId()).isEqualTo(1L);
    assertThat(actual.getCatalogItems().get(1).getId()).isEqualTo(2L);
    // モックが想定通り呼び出されていることの確認
