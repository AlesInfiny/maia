...
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.generated.entity.BasketEntity;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.generated.entity.BasketEntityExample;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.generated.entity.BasketItemEntity;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.generated.entity.BasketItemEntityExample;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.generated.mapper.BasketItemMapper;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.generated.mapper.BasketMapper;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.mapper.JoinedBasketMapper;
import com.dressca.applicationmodules.shopping.internal.infrastructure.repository.mybatis.translator.ShoppingEntityTranslator;
...
public class MybatisBasketRepository implements BasketRepository {
  ...
  public Basket add(Basket basket) {
    BasketEntity row = ShoppingEntityTranslator.createBasketEntity(basket);
    basketMapper.insert(row);

    // 子要素（ BasketItem ）の追加
    List<BasketItemEntity> itemRows = basket.getItems().stream()
        .map(ShoppingEntityTranslator::createBasketItemEntity).collect(Collectors.toList());
  ...
  public void update(Basket basket) {
    ...
    basket.getItems().stream().map(ShoppingEntityTranslator::createBasketItemEntity)
