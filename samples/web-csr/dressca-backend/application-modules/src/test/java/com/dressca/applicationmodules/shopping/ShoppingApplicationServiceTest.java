...
import com.dressca.applicationmodules.ApplicationModulesTestConfig;
...
import com.dressca.applicationmodules.shopping.entity.DisplayItemAsset;
...
import com.dressca.applicationmodules.shopping.exception.BasketNotFoundException;
...
@Import(ApplicationModulesTestConfig.class)
@TestPropertySource(
    properties = "spring.messages.basename=applicationmodules.messages,systemcommon.messages")
