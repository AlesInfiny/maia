...
public class OrderItemEntityExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addOrderedDisplayItemIdCriterion(String condition, Object value, String property) {
            ...
            orderedDisplayItemIdCriteria.add(new Criterion(condition, value, "com.dressca.domainmodules.persistence.UuidTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addOrderedDisplayItemIdCriterion(String condition, UUID value1, UUID value2, String property) {
            ...
            orderedDisplayItemIdCriteria.add(new Criterion(condition, value1, value2, "com.dressca.domainmodules.persistence.UuidTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addOrderIdCriterion(String condition, Object value, String property) {
            ...
            orderIdCriteria.add(new Criterion(condition, value, "com.dressca.domainmodules.persistence.UuidTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addOrderIdCriterion(String condition, UUID value1, UUID value2, String property) {
            ...
            orderIdCriteria.add(new Criterion(condition, value1, value2, "com.dressca.domainmodules.persistence.UuidTypeHandler"));
            allCriteria = null;
        }
