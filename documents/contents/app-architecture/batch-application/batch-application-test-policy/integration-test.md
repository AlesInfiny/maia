...
AlesInfiny Maia のバッチアプリケーションにおける結合テストでは、 [JobOperatorTestUtils :material-open-in-new:](https://docs.spring.io/spring-batch/reference/api/org/springframework/batch/test/JobOperatorTestUtils.html){ target=_blank } を利用します。
