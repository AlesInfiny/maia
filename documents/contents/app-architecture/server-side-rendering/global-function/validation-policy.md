...
ビューモデルや API モデルのフィールドに単項目チェックを行うアノテーションを付与します。
...
必要に応じて、ビューにもビューモデルや API モデルと同様の入力チェックが可能なように実装します。
...
画面のあるアプリケーションでは、コントローラーで業務例外をキャッチし、ビューモデルにエラーメッセージを設定します。
