...
root/ -------------------------------------------------- root フォルダー
 ...
 │ └ i18n/ --------------------------------------------- aaa 機能の業務メッセージのプロパティファイルを一括管理するフォルダー
 │    ├ messages_en.properties ------------------------- aaa 業務メッセージのプロパティファイル（英語）
 │    └ messages_ja.properties ------------------------- aaa 業務メッセージのプロパティファイル（日本語）
 └ web/src/main/resources
   ├ i18n/ --------------------------------------------- UI メッセージのプロパティファイルを一括管理するフォルダー
   │  └ aaa/ ---------------------------------- aaa機能のプロパティファイルを管理するフォルダー
   |     └ register/
